...
function Hero() {
  return (
    <section className="relative isolate flex min-h-[88vh] flex-col overflow-hidden bg-forest-deep">
      ...
      <div className="relative z-10 flex flex-1 flex-col px-4 pt-24 sm:px-8">
        {/* The section nav (About / Billboards / How it works) now lives in the
            global Header's top bar alongside the sign-in controls, so the hero
            opens straight into the caption — sitting just below that top row. */}
